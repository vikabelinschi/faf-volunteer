...
import md.faf.volunteer.config.audit.AuditEventConverter;
import md.faf.volunteer.domain.PersistentAuditEvent;
...
import static md.faf.volunteer.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
